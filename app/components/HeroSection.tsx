		...
		<section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden py-16 sm:py-20">
			...
			<div className="container mx-auto px-4 z-10">
				<div className="text-center mb-8">
					...
					<h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-6 text-gray-800">Orbit Dev Studio</h2>
					<p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed px-4">
						Crafting exceptional mobile experiences for
						<span className="text-blue-700 font-medium"> iOS</span>, and <span className="text-purple-700 font-medium"> Android</span> with
						<span className="text-blue-700 font-medium"> Flutter</span>
					</p>
				</div>
